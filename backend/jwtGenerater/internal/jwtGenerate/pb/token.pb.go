...
func (x *RequsetLogin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequsetLogin) ProtoMessage() {}

func (x *RequsetLogin) ProtoReflect() protoreflect.Message {
	mi := &file_token_proto_msgTypes[0]
...
// Deprecated: Use RequsetLogin.ProtoReflect.Descriptor instead.
func (*RequsetLogin) Descriptor() ([]byte, []int) {
	return file_token_proto_rawDescGZIP(), []int{0}
}

func (x *RequsetLogin) GetAccount() string {
	if x != nil {
		return x.Account
	}
	return ""
...
func (x *RequsetLogin) GetPasswordHash() string {
	if x != nil {
...
func (x *RespondLogin) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RespondLogin) ProtoMessage() {}

func (x *RespondLogin) ProtoReflect() protoreflect.Message {
	mi := &file_token_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RespondLogin.ProtoReflect.Descriptor instead.
func (*RespondLogin) Descriptor() ([]byte, []int) {
	return file_token_proto_rawDescGZIP(), []int{1}
}

func (x *RespondLogin) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *RespondLogin) GetErrorMessage() string {
	if x != nil {
...
func (x *RespondLogin) GetData() *Tokens {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_token_proto_rawDesc = []byte{
	...
	0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x4c, 0x0a, 0x0c, 0x52, 0x65, 0x71, 0x75, 0x73,
	0x65, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	0x64, 0x48, 0x61, 0x73, 0x68, 0x22, 0x7a, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x64,
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x5f,
	...
	0x72, 0x72, 0x6f, 0x72, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x24, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x4a, 0x77, 0x74, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x52, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x4e, 0x0a, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x61,
	...
	0x6e, 0x32, 0x45, 0x0a, 0x08, 0x4a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x39, 0x0a,
	0x05, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x16, 0x2e, 0x4a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x73, 0x65, 0x74, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x1a, 0x16,
	0x2e, 0x4a, 0x77, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x64, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x22, 0x00, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x3b, 0x4a,
	0x77, 0x74, 0x47, 0x65, 0x72, 0x65, 0x72, 0x61, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_token_proto_goTypes = []interface{}{
	(*RequsetLogin)(nil), // 0: JwtToken.RequsetLogin
	(*RespondLogin)(nil), // 1: JwtToken.RespondLogin
	(*Tokens)(nil),       // 2: JwtToken.tokens
}
var file_token_proto_depIdxs = []int32{
	2, // 0: JwtToken.RespondLogin.data:type_name -> JwtToken.tokens
	0, // 1: JwtToken.JwtToken.Login:input_type -> JwtToken.RequsetLogin
	1, // 2: JwtToken.JwtToken.Login:output_type -> JwtToken.RespondLogin
