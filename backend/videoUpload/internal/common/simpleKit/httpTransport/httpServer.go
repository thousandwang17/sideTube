 ...
 * @LastEditTime: 2023-02-03 14:11:28
 * @FilePath: /videoUpload/internal/common/simpleKit/httpTransport/httpServer.go
...
import (
	...
	"log"
	"net/http"
	p "sideTube/videoUpload/internal/common/simpleKit/endpoint"
)
