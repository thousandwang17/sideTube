 ...
 * @LastEditTime: 2023-02-11 11:47:13
...
func DeleteMessageRegister(svc service.VideoMessageCommend, v *validator.Validate) *httptransport.HttpTransport {
	var ep endpoint.EndPoint
	ep = videoEnpoint.MakeDeleteMessageEndPoint(svc)
...
func decodeDeleteMessageRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var request videoEnpoint.DeleteMessageRequest
...
func encodeDeleteMessageResponse(_ context.Context, w http.ResponseWriter, response interface{}) error {
