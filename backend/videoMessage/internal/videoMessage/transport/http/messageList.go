 ...
 * @LastEditTime: 2023-02-10 18:27:43
...
func MessageListRegister(svc service.VideoMessageCommend, v *validator.Validate) *httptransport.HttpTransport {
	var ep endpoint.EndPoint
	ep = videoEnpoint.MakeMessageListEndPoint(svc)
	ep = middleware.ValidMiddleWare(v)(ep)

	return httptransport.NewHttpTransport(
		ep,
		decodeMessageListRequest,
		encodeMessageListResponse,
	)
}

func decodeMessageListRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var request videoEnpoint.MessageListRequest
...
func encodeMessageListResponse(_ context.Context, w http.ResponseWriter, response interface{}) error {
