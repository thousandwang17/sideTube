 ...
 * @LastEditTime: 2023-02-11 11:47:28
...
func ReplyRegister(svc service.VideoMessageCommend, v *validator.Validate) *httptransport.HttpTransport {
	var ep endpoint.EndPoint
	ep = videoEnpoint.MakeReplyEndPoint(svc)
...
func decodeReplyRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var request videoEnpoint.ReplyRequest
...
func encodeReplyResponse(_ context.Context, w http.ResponseWriter, response interface{}) error {
