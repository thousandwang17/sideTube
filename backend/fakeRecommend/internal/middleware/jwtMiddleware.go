 ...
 * @LastEditTime: 2023-03-07 15:50:15
 * @FilePath: /recommend/internal/middleware/jwtMiddleware.go
...
func JwtMiddleWare() endpoint.MiddleWare {
	return func(next endpoint.EndPoint) endpoint.EndPoint {
		return func(ctx context.Context, request interface{}) (interface{}, error) {
			...
			//   Guest request without a jwtToken
			if token, ok := ctx.Value("jwtToken").(string); ok && token == "" {
