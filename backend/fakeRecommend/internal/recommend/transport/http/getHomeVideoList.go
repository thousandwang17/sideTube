 ...
 * @LastEditTime: 2023-03-05 15:18:07
...
func GetHomeVideoListRegister(svc service.RecommendCommend, v *validator.Validate) *httptransport.HttpTransport {
	var ep endpoint.EndPoint
	ep = videoEnpoint.MakeGetHomeVideoListEndPoint(svc)
	ep = middleware.JwtMiddleWare()(ep)
	ep = middleware.ValidMiddleWare(v)(ep)

	return httptransport.NewHttpTransport(
		ep,
		decodeGetHomeVideoListRequest,
		encodeGetHomeVideoListResponse,
		httptransport.NewServerBefore(middleware.JwtServerBerore()),
	)
}

func decodeGetHomeVideoListRequest(_ context.Context, r *http.Request) (interface{}, error) {
	var request videoEnpoint.GetHomeVideoListRequest
...
func encodeGetHomeVideoListResponse(_ context.Context, w http.ResponseWriter, response interface{}) error {
