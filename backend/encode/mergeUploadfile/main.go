 ...
 * @LastEditTime: 2023-02-17 19:44:12
...
import (
	"log"
	"mergeUploadFile/internal/common/rabbitmq"
	locker "mergeUploadFile/internal/common/redis"
	"mergeUploadFile/internal/worker"
	"mergeUploadFile/internal/worker/handler"
	"mergeUploadFile/internal/worker/lockRepo"
	"mergeUploadFile/internal/worker/queueRepo"
	"mergeUploadFile/internal/worker/videoRepo"
	"os"
	"os/signal"
	"syscall"
)
...
func main() {
	...
	worker := handler.New(
		...
		queueRepo.NewRabbitmq(rabbitmq.GetRabbitClient()),
	)
