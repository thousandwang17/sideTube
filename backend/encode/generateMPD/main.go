 ...
 * @LastEditTime: 2023-02-22 21:47:16
...
import (
	"generateMPD/internal/common/mongodb"
	"generateMPD/internal/common/rabbitmq"
	locker "generateMPD/internal/common/redis"
	"generateMPD/internal/worker"
	"generateMPD/internal/worker/handler"
	"generateMPD/internal/worker/lockRepo"
	"generateMPD/internal/worker/metaRepo"
	"generateMPD/internal/worker/queueRepo"
	"generateMPD/internal/worker/videoRepo"
	"log"
	"os"
	"os/signal"
	"syscall"
...
func main() {
	...
	worker := handler.New(
		...
		metaRepo.NewMongoRepo(mongodb.GetMongoClient()),
	)
