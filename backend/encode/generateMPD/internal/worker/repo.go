 ...
 * @LastEditTime: 2023-02-22 21:25:07
...
type VideoRepository interface {
	...
	GenerateMPD(c context.Context, videoID string, videoList, audioList []string) (mpdFileName, pngfileName string, err error)
}

type MetaRepo interface {
	UpdateStateAndFileNames(c context.Context, mission Mission, mpdFileName, pngfileName string) error
}
