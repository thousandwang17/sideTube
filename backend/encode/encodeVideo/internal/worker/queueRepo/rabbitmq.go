 ...
 * @LastEditTime: 2023-03-10 22:02:23
...
func (q queue) PublishMergeEncodedVideo(ctx context.Context, missions []byte) error {
	return q.client.PublishMergeEncodedVideo(ctx, missions)
}
