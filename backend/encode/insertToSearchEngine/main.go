 ...
 * @LastEditTime: 2023-03-14 16:41:54
...
import (
	...
	"os/signal"
	"syscall"
	"toSearchEngine/internal/common/elastic"
	"toSearchEngine/internal/common/mongodb"
	"toSearchEngine/internal/common/rabbitmq"
	"toSearchEngine/internal/worker"
	"toSearchEngine/internal/worker/handler"
	"toSearchEngine/internal/worker/metaRepo"
	"toSearchEngine/internal/worker/queueRepo"
