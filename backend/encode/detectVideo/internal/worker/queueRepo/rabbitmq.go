 ...
 * @LastEditTime: 2023-02-18 22:58:40
...
func (q queue) PublishEncodeVideo(ctx context.Context, missions [][]byte) error {
	return q.client.PublishEncodeVideo(ctx, missions)
}
